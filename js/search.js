...
async function SearchAnime(query, page = 1) {
    ...
    for (let i = 0; i < animes.length; i++) {
        ...
        // Check if the anime title includes "dub" (case insensitive)
        if (anime["title"].toLowerCase().includes("dub")) {
            anime["subOrDub"] = "DUB"; // Set subOrDub property to "DUB" for dubbed anime
            // Generate HTML only for dubbed anime
